...
private:
	...
	void										addDefinedChain( const NS_CORE MultiLink& chain, const VariableValue & value, const NS_CORE GearNumber& gear );
	void										addUndefinedChain( const NS_CORE MultiLink& chain, const VariableValue & value, const NS_CORE GearNumber& gear );
...
public:
	...
	bool										addGearChains( const NS_CORE MultiLinkArray& chains, const NS_CORE GearNumber& gear, const NS_CORE RatioValue i );
