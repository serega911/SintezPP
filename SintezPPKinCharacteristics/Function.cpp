...
ari::Function::Function( const NS_CORE N& n, const NS_CORE GearSetNumber gearSet )
{
...
int Function::sign( char c )
{
	...
	case '0': return 0;
	default:
		NS_CORE Log::warning( true, "wrong signum", NS_CORE Log::CRITICAL, HERE );
		return -2;
	}
}

ari::Function_p ari::Function::create( const NS_CORE InternalGearRatioValue& k, const NS_CORE W& w, const NS_CORE N& n, const NS_CORE GearSetNumber gearSet )
{
	NS_CORE Element sun( NS_CORE eMainElement::SUN_GEAR, gearSet );
	NS_CORE Element epy( NS_CORE eMainElement::EPICYCLIC_GEAR, gearSet );
	NS_CORE Element car( NS_CORE eMainElement::CARRIER, gearSet );
	...
	if ( signA * signB > 0 && signA * signH < 0 )
		return createAD( k, w, n, gearSet );
	if ( signA * signH > 0 && signA * signB < 0 )
		return createBE( k, w, n, gearSet );
...
ari::Function_p ari::Function::createBE( const NS_CORE InternalGearRatioValue& k, const NS_CORE W& w, const NS_CORE N& n, const NS_CORE GearSetNumber gearSet )
{
	NS_CORE Element sun( NS_CORE eMainElement::SUN_GEAR, gearSet );
	NS_CORE Element epy( NS_CORE eMainElement::EPICYCLIC_GEAR, gearSet );
	NS_CORE Element car( NS_CORE eMainElement::CARRIER, gearSet );
...
ari::Function_p ari::Function::createCF( const NS_CORE InternalGearRatioValue& k, const NS_CORE W& w, const NS_CORE N& n, const NS_CORE GearSetNumber gearSet )
{
	NS_CORE Element sun( NS_CORE eMainElement::SUN_GEAR, gearSet );
	NS_CORE Element epy( NS_CORE eMainElement::EPICYCLIC_GEAR, gearSet );
	NS_CORE Element car( NS_CORE eMainElement::CARRIER, gearSet );
